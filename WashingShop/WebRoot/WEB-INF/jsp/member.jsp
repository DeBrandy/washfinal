...
<html>
  ...
  <body>
	...
	<td style="width:100px"><input type="submit" class="btn btn-primary center-block" value="查询" onclick="/Member/findOne"/></td>
	<td style="width:250px"></td>
	<td style="width:150px"><input type="button" class="btn btn-primary" value="按手机号排序" onclick="/Member/sortByCid"/></td>
	<td style="width:150px"><input type="button" class="btn btn-primary" value="按总消费排序" onclick="/Member/sortByCcost"/></td>
	<td><input type="button" class="btn btn-primary" value="按余额排序" onclick="/Member/sortByCba"/></td>
	</tr>
	</table>
	</form>
	...
	<table class="table table-hover center-block" id="MTable" style="width:1000px;text-align:center">
        		...
        		<td>${a.Cname}</td>
       		    ...
       		    <td>${a.Ccost}</td>
       		    <td>${a.Discount}</td>
			    <td><a href="/Member/delete?Cid=${a.Cid}"><input type="button" value="删除" class="btn btn-primary center-block"></a></td>
			    <td><a href="member.jsp?Cid_1=${a.Cid}"><input type="button" value="修改" class="btn btn-primary center-block" data-toggle="modal" data-target="#DModal"></a></td>
      			</tr>
    ...
    <form method="post" action="/Member/insert" class="form-horizontal" role="form" id="myForm1" onsubmit="return ">
    ...
    <form method="post" action="/Member/invest" class="form-horizontal" role="form" id="myForm2" onsubmit="return ">
    ...
    <form method="post" action="/Member/update" class="form-horizontal" role="form" id="myForm3" onsubmit="return ">
